...
async function uploadWrappers() {
  console.log(`🚀 Iniciando carga correcta de ${wrappers.length} wrappers...`);
  let successCount = 0;
  let errorCount = 0;

  ...
  return (
    <section className="bg-gradient-to-r from-promo-yellow to-yellow-400 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-800 mb-8 max-w-3xl mx-auto">La enciclopedia Oficial de promocionales mexicanos. Desde Tazos hasta Funki Punky, descubre todas las promociones que marcaron tu infancia.</p>
